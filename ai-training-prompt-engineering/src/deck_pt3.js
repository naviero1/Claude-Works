...
module.exports = function buildPartThree(pres, H) {
  ...
  s.addText('OPTIONS — every option ships with when-to-use guidance, and every slot with a research-backed “Why it matters.” You pick from a vetted menu instead of composing from scratch.', { x: 7.3, y: 3.78, w: 5.2, h: 0.72, fontFace: F.body, fontSize: 9.5, italic: true, color: C.SLATE, margin: 0, lineSpacingMultiple: 1.06 });
  ...
  s.addNotes(
    'HOW TO PRESENT — 1) Hold up the physical handout (or show the PDF) and name it: “the Prompt Element Taxonomy — your field map; everyone gets one.” 2) Say what it IS in one breath: “everything we just did — elements, their slots, and proven ways to fill them — cataloged, with when-to-use guidance on every option.” 3) LEFT bullets top to bottom: parts catalog → two wings (generative now, agentic in Part 5) → one source of truth, three doors (reference, Creator, Configurator). 4) RIGHT card: walk the tree ONCE — element Role → attribute identity → options “Careful analyst” / “Precise editor” — “you pick from a vetted menu instead of composing from scratch.” Add the v1.4 line: “and every slot answers WHY it matters — what that dial does to your output, with the research behind it; two reference slides near the end map the whole evidence base.” 5) Bottom band: sweep the four numbers (19 elements · 78 attributes · ~290 options · 18 presets), then the pack. 6) Set the expectation: “you don’t study this — you look things up in it, like a catalog.” 7) Bridge: “with the map in hand — seven techniques that cover almost everything.”\n' +
