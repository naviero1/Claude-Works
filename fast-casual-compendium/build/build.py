...
def sec_findings():
    ...
    cards = [
      ('f-money', f"{F['r_price_health']:+.2f}", 'price against health, all 60 dishes',
      ...
      ('f-warn', f"{quinoa['mg']:,}&#8202;mg", 'in a portion of plain quinoa',
      ...
      ('f-flav', f"{F['dupe_priciest_wins']} of {len(F['dupes'])}", 'times the priciest version wins',
